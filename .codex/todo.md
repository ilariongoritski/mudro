...
- [ ] 2026-03-22 | P0 | area:security | Ротация засвеченных секретов (Telegram/OpenAI)
  ...
  - Прогресс 2026-03-23: tracked ops-файлы очищены от hardcoded credentials; прод-контур переведен на `env/*.env`
  - Следующий шаг: перевыпустить токены/ключи и обновить `env/*.env` на VPS
